...
class _NewNoteState extends State<NewNote> {
  FocusNode nextField;
  DatabaseHelper addNoteToDB = DatabaseHelper();
      ...
      body: ChangeNotifierProvider(
        create: (context) => UpdateList(),
              child: Consumer<UpdateList>(
                builder: (context, provider, child) => ChangeNotifierProvider<UserColor>(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    if(_text.text.isEmpty)
                                    {
                                      ...
                                      //TODO Display message "note not saved"
                                    }

                                    final Future<Database> addNote = addNoteToDB.initializeDB();
                                    addNote.then((database) {
                                      addNoteToDB.insertNote(Note(_text.text,Provider.of<UserColor>(context)
                                            .userColor));
                                    });
                                    setState(() {
                                    ...
                                    Navigator.pop(context);
                                    //TODO update list view at 'homepage.dart'
                                  },
                                  child: Container(
